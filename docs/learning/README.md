...
| 2 · Platform | Policy as code, metrics/logs/traces, secrets management, log retention, TLS automation | [PKI and trust anchors](concepts/pki-and-trust-anchors.md) · [Observability and resource bounds](concepts/observability-and-resource-bounds.md) |
