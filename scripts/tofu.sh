...
# Secret zero comes from TOFU_STATE_PASSPHRASE or the macOS Keychain (ADR 0026);
...
# The GitHub provider reuses the gh CLI's token (already in the OS keychain) instead of a new secret.
