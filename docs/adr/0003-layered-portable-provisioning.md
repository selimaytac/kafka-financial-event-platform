...
The platform must run on a laptop today (18 GB RAM, of which roughly half is free;
Docker gets ~8 GB) and be movable to an on-prem hypervisor or a cloud later without a
